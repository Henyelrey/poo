...
//txtAutoCompDNI.setText(AutoCompleteTextField.dataGetReturnet.getIdx());
                    txtIdCarrera.setText(AutoCompleteTextField.dataGetReturnet.getIdx());
                }
            }
        });
    }
...
//JOptionPane.showMessageDialog(this, "Re registro");
            ...
            try {
                ...
                if (validator.isPasses()) {
                    msg = new MsgBox();
                    if (msg.showConfirmCustom("Esta seguro de crear un nuevocliente ? ", "  Mensaje de Confirmación", "") == 0) {
                        if (cDao.create(to) != 0) {
                            listarDatos();
                            resetForm();
